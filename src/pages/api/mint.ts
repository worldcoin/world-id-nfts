...
const rpc = new InfuraProvider(137, process.env.NEXT_PUBLIC_INFURA_ID)
...
const handler = async (req: NextApiRequest, res: NextApiResponse) => {
	...
	const call = await contract.mint.populateTransaction(
		address,
	...
	const tx = await relayer.sendTransaction({
		data: call.data,
		gasLimit: 500_000,
		to: process.env.NEXT_PUBLIC_INFURA_ID,
	})
